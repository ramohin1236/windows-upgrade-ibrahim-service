 ...
 <div className='flex flex-col gap-16'>
        ...
        <div>
            <div className='flex items-center gap-4 '>
                ...
                <p className='font-semibold text-md md:text-xl text-color pb-3'>SERVICES</p>
                
            </div>
            <h3 className='font-semibold text-2xl md:text-4xl flex flex-col gap-6'>Popular Service Provider</h3>
        </div>
          ...
          >
            ...
            <div className="mt-4">
              <div className="flex items-center justify-between text-sm text-black">
                <div className="flex items-center gap-1"> <Image src={mapPin} alt="Location" height={20} /> {service.location}</div>
