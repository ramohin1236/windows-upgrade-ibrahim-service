...
const data = [
    { id: 1, cateName: "House Cleaning", providers: "4982 Providers" , icon: cateimg1 },
    { id: 2, cateName: "Electricity Services", providers: "3,866 Providers" , icon: cateimg2 },
    { id: 3, cateName: "Furniture Replacement", providers: "1,894 Providers" , icon: service3 },
    { id: 4, cateName: "Mechanic Zone", providers: "2,894 Providers" , icon: service4 },
    { id: 5, cateName: "Plumber Service", providers: "3,894 Providers" , icon: service5 },
    { id: 6, cateName: "Painter Chaise", providers: "2,754 Providers" , icon: service6 },
]
    ...
    <div className='flex flex-col gap-16'>
        ...
        <div>
            <div className='flex items-center gap-4 '>
                <Image src={popularcateIcon} alt="Popular Category " height={24}/>
                <p className='font-semibold text-md md:text-xl text-color pb-3'>CATEGORIES</p>
                
            </div>
            <h3 className='font-semibold text-2xl md:text-4xl flex flex-col gap-6'>Most Popular Categories</h3>
        </div>
        <div className='flex'>
             <Link
                href="/register"
